                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= base_url(); ?>/produk/tambah_produk">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" autocomplete="off" placeholder="Masukan Nama Produk..." value="<?= set_value('nama');  ?>">
                                <?= form_error('nama', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class=" form-row">
                                <div class="form-group col-md-6">
                                    <label for="harga_beli">Harga Beli Produk (Rp)</label>
                                    <input type="text" class="form-control" id="harga_beli" name="harga_beli" autocomplete="off" placeholder="Masukan Harga Beli Produk..." value="<?= set_value('harga_beli');  ?>">
                                    <?= form_error('harga_beli', '<small class="form-text text-danger">', '</small>'); ?>
                                </div>
                                <div class=" form-group col-md-6">
                                    <label for="harga_jual">Harga Jual Produk (Rp)</label>
                                    <input type="text" class="form-control" id="harga_jual" name="harga_jual" autocomplete="off" placeholder="Masukan Harga Jual Produk..." value="<?= set_value('harga_jual');  ?>">
